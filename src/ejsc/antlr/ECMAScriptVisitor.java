...
public interface ECMAScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ECMAScriptParser#expressionSequenceOpt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpressionSequenceOpt(ECMAScriptParser.ExpressionSequenceOptContext ctx);
	/**
